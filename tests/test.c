...
static const u8 triangle_frag_code[]  = {
...
static const u8 triangle_vert_code[]  = {
  ...
  0x72, 0x00, 0x00, 0x00, 0x47, 0x00, 0x03, 0x00, 0x20, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 
...
int main(void) {
    ...
    Oga_Logical_Engines_Create_Desc *compute_engine_desc = &context_desc.logical_engine_create_descs[family_index_compute];
    ...
    ///
    // Retrieve queues
    Oga_Logical_Engine graphics_engine = context->logical_engines_by_family[family_index_graphics].logical_engines[logical_engine_index_graphics];
    Oga_Logical_Engine present_engine = context->logical_engines_by_family[family_index_present].logical_engines[logical_engine_index_present];
    Oga_Logical_Engine compute_engine = context->logical_engines_by_family[family_index_compute].logical_engines[logical_engine_index_compute];
