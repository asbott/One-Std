...
#include <unistd.h>// _to_win_sock_err: Map our internal Socket_Result codes to Unix error codes.
int _to_win_sock_err(Socket_Result r) {
    switch(r) {
        case SOCKET_OK:                  return 0;
        case SOCKET_DISCONNECTED:        return ECONNRESET;
        case SOCKET_NOT_INITIALIZED:     return EINVAL; /* No Unix equivalent */
...
// sys_convert_address_string: Converts a string IP address to a u32 using inet_addr.
u32 sys_convert_address_string(string address) {
...
// sys_socket_init: Create a new socket given the domain, type, and protocol.
...
// sys_socket_bind: Bind the socket to the specified IPv4 address and port.
...
// sys_socket_listen: Listen on the socket with the given backlog.
...
// sys_socket_accept: Accept an incoming connection on the socket.
...
// sys_socket_connect: Connect the socket to the specified IPv4 address and port.
Socket_Result sys_socket_connect(Socket sock, u32 address, u16 port, Socket_Domain domain) {
...
// sys_socket_send: Send data over the socket.
...
// sys_socket_recv: Receive data from the socket.
...
// sys_socket_close: Close the socket.
...
// sys_socket_set_blocking: Set or clear non-blocking mode on the socket.
